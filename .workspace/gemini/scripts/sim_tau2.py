...
print("tau=1, gamma=0.005:", run_sim(1, 0.005))
print("tau=50, gamma=0.005:", run_sim(50, 0.005))
print("tau=1, gamma=0.02:", run_sim(1, 0.02))
print("tau=50, gamma=0.02:", run_sim(50, 0.02))
