%%% Introduction outline for "Proper Calibeating" — by Claude
%%% Revised structure after literature survey.
%%%
%%% This is a standalone outline file; the actual \section{Introduction}
%%% remains in calib-proper.tex (currently holding the earlier version).
%%% Once the author picks a winner among Claude/GPT/Gemini drafts,
%%% the chosen version replaces what's in the main file.

%% ====================================================================
%% 1. SETUP AND THE QUESTION
%% ====================================================================
%%
%% Merges the old "scoring rules background" and "the question" into a
%% single brisk opening.  The audience already knows what proper scoring
%% rules are; we set up the problem, not the field.
...
\medskip
This question is ``in the air'': Kleinberg, Leme, Schneider, and Teng
(2023) study U-calibration, asking what forecasting criterion guarantees
low regret for \emph{every} bounded scoring rule.  Chen, Huang, Jordan,
and Luo (2026) reduce calibeating to online learning and obtain results
for general proper losses, one loss at a time.  We take a different
approach: we work uniformly over the class $\mathcal{L}_{1}$ of all
proper $1$-Lipschitz scoring rules, and show that the existing
Brier-score procedures already achieve this uniformity.  (We exclude
rules with infinite losses, such as the logarithmic rule.)
...
Kleinberg, Leme, Schneider, and Teng (2023),
Chen, Huang, Jordan, and Luo (2026).
Background on proper scoring rules: Savage (1971), McCarthy (1956),
Gneiting and Raftery (2007).
On calibration: Dawid (1982).


%% ====================================================================
%% 2. CALIBRATION TRANSFERS FOR FREE
%% ====================================================================

\subsubsection*{2. Result: calibration is automatically proper-calibration}
...
%% ====================================================================
%% 3. CALIBEATING DOES NOT TRANSFER
%% ====================================================================

\subsubsection*{3. Result: calibeating does NOT imply proper calibeating}
...
\medskip\noindent\textbf{Cite:}
Foster and Hart (2023),
Gneiting and Raftery (2007) (for the spherical scoring rule family).


%% ====================================================================
%% 4. THREE ROUTES TO PROPER CALIBEATING (+ MULTICALIBEATING)
%% ====================================================================

\subsubsection*{4. Results: proper calibeating}
...
The key insight is that calibeating plus calibration is \emph{not}
sufficient for proper calibeating; one needs calibeating of the
\emph{joint} $\mathbf{b}\times\mathbf{c}$.  The counterexample in
Section~3 illustrates exactly this gap.
...
%% ====================================================================
%% 5. COMPARISON WITH CONCURRENT AND RELATED WORK
%% ====================================================================

\subsubsection*{5. Comparison with concurrent and related work}
