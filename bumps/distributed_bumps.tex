...
\textbf{Scenario B: Persistent Diversity (Proportional Annealing).} However, our analytic derivation in the previous section established that the optimal tuning rule is $\gamma \propto \eta b$. If we follow this geometric principle, then as we decay the learning rate $\eta \to 0$, we must \emph{simultaneously and proportionally} decay the consensus coupling $\gamma \to 0$. 
